...
<div class="about-bg-section">
        ...
        <div class="container">
            ...
            <div class="story-grid">
                ...
                <div style="perspective: 1000px; transform-style: preserve-3d;">
                    ...
                    <img src="https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=800&auto=format&fit=crop" alt="RM Sampoorna Kitchen Spices" class="heritage-3d-img">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="padding-bottom: 80px;">
        ...
        <div class="section-title" style="margin-top: 20px; margin-bottom: 40px; text-align: center;">
            ...
            <h2 class="about-title" style="font-size: 2.2rem; margin-bottom: 0;">Why Families Love RM's Sampoorna</h2>
        </div>
